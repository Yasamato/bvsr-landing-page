  ...
  return (
    <Container>
      ...
      <article>
        ...
        >
          <Link href={"/liftoff"}>
            <Button>Event Anmeldung</Button>
          </Link>
        </div>

        <h2>Wer sind wir und was ist das Ziel von BVSR-Liftoff?</h2>
        <p>
          Willkommen beim BVSR-Liftoff, der bahnbrechenden Initiative des
          Bundesverbands Studentischer Raumfahrt (BVSR)! Wir sind eine
          dynamische Gruppe von Studierenden aus ganz Deutschland, deren
          gemeinsame Leidenschaft die Raumfahrt ist. Unsere Mission ist es, dich
          und Gleichgesinnte auf das aufregende Abenteuer der Startup-Gründung
          und den nahtlosen Einstieg in die berufliche Welt der Raumfahrt
          vorzubereiten. Unser ultimatives Ziel? Die Startup-Kultur in
          Deutschland auf Touren zu bringen, um eine fruchtbare
          Wirtschaftslandschaft für Gründerinnen und Gründer wie dich zu
          schaffen. Wir sind hier, um deinen Traum von der Raumfahrt Realität
          werden zu lassen!
        </p>
        <div
          style={{
        ...
        <h2>Die wichtigsten Infos zum Event am 3.11.2023 in Würzburg</h2>
        <p>
        ...
        <Table striped highlightOnHover>
          ...
          <tbody>
            ...
            <tr>
              <td>14:30 - 14:45 Uhr</td>
              <td>
                <h5>Pause</h5>
              </td>
            </tr>
            <tr>
              <td>14:45 - 16:15 Uhr</td>
              <td>
                <h5>Workshops</h5>
              </td>
            </tr>
            <tr>
              <td>16:15 - 16:45 Uhr</td>
              <td>
            ...
            <tr>
              <td>16:45 - 17:15 Uhr</td>
              <td>
                <h5>Founder erzählen, Podiumsdiskussion</h5>
                Lokale Founder aus dem Bereich Technik und Raumfahrt erzählen
            ...
            <tr>
              ...
              <td>
                ...
                Ein lockerer Ausklang und die Möglichkeit, mit Firmen,
                Inkubatoren und Gründern ins Gespräch zu kommen.
              </td>
            </tr>
          </tbody>
        </Table>
        ...
        <p>
          Die BVSR-Liftoff Veranstaltung am 3. November 2023 bietet nicht nur
          die Gelegenheit, dich mit Gleichgesinnten zu vernetzen, sondern auch
          ein spannendes Programm, das dich in die Welt der Raumfahrt-Startups
          einführt und dir die Werkzeuge für deinen eigenen erfolgreichen Start
          in dieser aufregenden Branche an die Hand gibt. Wir freuen uns darauf,
          dich in Würzburg begrüßen zu dürfen, wo die Zukunft der Raumfahrt
          geschrieben wird!
        </p>

        <h2>Wer wird dabei sein?</h2>
        ...
        <Grid justify="flex-start" align="stretch">
          ...
          <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
            Die Frage lautet nicht nur &ldquo;Wer wird dabei sein?&rdquo;,
            sondern &ldquo;Wirst du dabei sein?&rdquo; Du, als angehender
            ...
            der Raumfahrtbranche zu treffen, die bereits den Kosmos erobern.
            Diese einzigartige Gelegenheit zum Networking wird dir Einblicke und
        ...
        <p>
          Lasst uns gemeinsam die Zukunft der Raumfahrt in Deutschland
          gestalten! Hier sind einige inspirierende Impressionen, um deine
